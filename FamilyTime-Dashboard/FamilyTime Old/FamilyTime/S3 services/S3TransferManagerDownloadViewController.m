...
- (void)initS3Bucket
{
      ...
      if(self.tm == nil){
        if([AppDelegate appDelegate].accessKey.length >0)
        {
            ...
            //!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
            AmazonS3Client *s3 = [[AmazonS3Client alloc] initWithAccessKey:[AppDelegate appDelegate].accessKey
                                                             withSecretKey:[AppDelegate appDelegate].accessKey];
...
- (void)downloadFile:(NSString *)filePath key:(NSString *)nameOfFile {
    if(self.downloadFileOperation == nil || (self.downloadFileOperation.isFinished && !self.downloadFileOperation.isPaused)){
        self.filePath = [NSTemporaryDirectory() stringByAppendingPathComponent:@"download-tm-small-file.JPEG"];
        [[NSFileManager defaultManager] removeItemAtPath:self.filePath error: nil];
        self.totalBytesWritten = 0;
        self.downloadFileOperation = [self.tm downloadFile:self.filePath bucket:[Constant transferManagerBucket] key:nameOfFile];
    }
}
