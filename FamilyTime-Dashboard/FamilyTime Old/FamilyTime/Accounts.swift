...
//  FamilyTime
//
//  Created by Usama-Apps on 14/11/2022.
...
// MARK: - Accounts
class Accounts: NSObject,Codable {
    var profile: Profile?
    var billing: Billing?
...
// MARK: - Subscription
class Subscriptions: NSObject,Codable {
    var id: Int?
...
class Profile: NSObject,Codable {
    ...
    init(id: Int?, superUserID: Int?, name: String?, gender: String?, email: String?, phone: String?, type: String?, language: String?, createdAt: String?, package: String?) {
        self.id = id
