...
- (id)init
{
    ...
    if (self) {
        ...
        buttonTitles = @[[@"Close" myModification]];
...
//     ^^^ verticale line
    ...
    [dialogContainer setBackgroundColor:[UIColor whiteColor]];
...
- (void)addButtonsToView: (UIView *)container
{
    ...
    for (int i=0; i<[buttonTitles count]; i++) {
        ...
        [closeButton.titleLabel setFont:[UIFont fontWithName:@"OpenSans-Light" size:16] ];
