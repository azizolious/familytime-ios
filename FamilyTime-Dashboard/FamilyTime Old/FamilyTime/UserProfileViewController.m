...
-(void)viewWillAppear:(BOOL)animated
{
    ...
    [tracker set:kGAIScreenName value:@"User Profile"];
...
//            self.coverImg.clipsToBounds = YES;
        ...
        //        [self.s3Cont uploadBigFile:@"" key:imageName];
...
-(void) uploadProfilePictures{
    @try {
        ...
        dispatch_async(queue, ^{
            ...
            [self.s3Cont uploadBigFile:self.imagePath key:[NSString stringWithFormat:@"%@_%@/%@",delegate.parent.name,delegate.parent.user_id,self.imagePath.lastPathComponent]];
        });
    }
