...
//                mapview.clear()
    ...
    func drawRoute(_ startLocation: CLLocation?, destinationLocation: CLLocation?) {
        ...
        let urlString = "https://maps.googleapis.com/maps/api/directions/json?origin=\(origin)&destination=\(destination)&mode=driving&key=AIzaSyB2MKLJ9-RwtH4yDmO-RZJOLN0YGUVKZLQ"
