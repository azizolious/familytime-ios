...
+(NSInteger) daysDifferenceFromCurrentToDateString:(NSString *)endDateStr{
//    NSString *start = @"2018-11-01";
    
    NSDateFormatter *formatter = [[NSDateFormatter alloc] init];
    [formatter setDateFormat:@"yyyy-MM-dd"];
    
    NSDate *currentDate = [NSDate date];
    NSString *start = [formatter stringFromDate:currentDate];
...
+(NSInteger) secondsDifferenceFromCurrentToDateString:(NSString *)endDateStr{
    //    NSString *start = @"2018-11-01 15:40:10";
    ...
    NSLog(@"seconds = %ld", (long)[components second]);
    NSLog(@"minutes = %ld", (long)[components second]/60);
