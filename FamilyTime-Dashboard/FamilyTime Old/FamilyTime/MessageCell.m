...
-(CGFloat)height
{
    NSLog(@"%f",_bubbleImage.frame.size.height);
...
-(void)setTimeLabel
{
    ...
    _timeLabel.font = [UIFont fontWithName:@"OpenSans" size:12.0];
...
- (void)setBubble
{
    ...
    if (_message.sender == MessageSenderMyself)
    {
        ...
        _bubbleImage.tintColor = RGBCOLOR(32, 138, 255, 1);
    ...
    else
    {
        ...
        _bubbleImage.tintColor = RGBCOLOR(223, 222, 229, 1);
    }
