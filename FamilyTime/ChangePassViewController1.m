...
//#import "FTUtils.h"
//
//@interface ChangePassViewController1 ()
//
////@property (nonatomic,strong) ParentLoginViewController *loginCont;
//
//@end
//
//@implementation ChangePassViewController1
...
//{
//    NSString *userName = [[AppDelegate appDelegate].userDefault valueForKey:kForgotUserEmail];
//
...
//
//        [JSONHTTPClient postJSONFromURLWithString:kChangePassword_mesh2
//                                           params:params
...
//                                           else{
////                                               // reset keys
//                                               [[AppDelegate appDelegate].userDefault setValue:@"" forKey:kForgotUserEmail];
