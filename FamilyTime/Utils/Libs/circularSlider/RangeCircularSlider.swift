...
open class RangeCircularSlider: CircularSlider {
    ...
    */
    ...
    internal func isThumb(withCenter thumbCenter: CGPoint, containsPoint touchPoint: CGPoint) -> Bool {
        ...
        let angle = CircularSliderHelper.angle(betweenFirstPoint: thumbCenter, secondPoint: touchPoint, inCircleWithCenter: bounds.centert)
    ...
    override open func continueTracking(_ touch: UITouch, with event: UIEvent?) -> Bool {
        ...
        // the position of the pan gesture
        let touchPosition = touch.location(in: self)
        let startPoint = CGPoint(x: bounds.centert.x, y: 0)
