...
//
//@interface SyncSettingsPopupController11 ()<UIAlertViewDelegate>
...
//@end
//
//@implementation SyncSettingsPopupController11
//
...
//    [self.syncButton addTarget:self action:@selector(handleUpdate:) forControlEvents:UIControlEventTouchUpInside];
...
//{
//
//    [[UIApplication sharedApplication] openURL:[NSURL URLWithString:@"itms://itunes.apple.com/us/app/familytime-dashboard-parental-control-app/id981066103?mt=8"]];
//
//
//}
//
...
//                                      else
//                                      {
//                                          UIAlertView *alert = [[UIAlertView alloc] initWithTitle:[@"Sync Settings" myModification] message:updateSettings.response delegate:self cancelButtonTitle:@"OK" otherButtonTitles:nil, nil];
//                                          [alert show];
//
//                                          [[NSUserDefaults standardUserDefaults]setObject:@"YES" forKey:@"gobacknow"];
//                                          [[NSUserDefaults standardUserDefaults]synchronize];
...
//    if(IS_IPHONE_4)
//    {
//        button.frame = CGRectMake(0, CGRectGetMaxY(self.view.bounds) - 40.0f, CGRectGetWidth(self.view.bounds), 40.0f);
//        button.titleLabel.font = [UIFont fontWithName:@"OpenSans" size:13];
//    }
//    else if(IS_IPHONE_5)
//    {
...
//    else if(IS_IPHONE_6)
//    {
//        button.frame = CGRectMake(0 , CGRectGetMaxY(self.view.bounds) - 46.0f, CGRectGetWidth(self.view.bounds), 46.0f);
//        button.titleLabel.font = [UIFont fontWithName:@"OpenSans" size:14];
//    }
//    else if(IS_IPHONE_6_PLUS)
//    {
//        button.frame = CGRectMake(0, CGRectGetMaxY(self.view.bounds) - 52.0f, CGRectGetWidth(self.view.bounds), 52.0f);
//        button.titleLabel.font = [UIFont fontWithName:@"OpenSans" size:15];
//    }
//    else if(IS_IPHONE_X)
//        {
...
//    else
//    {
//        button.frame = CGRectMake(0, CGRectGetMaxY(self.view.bounds) - 78.0f, CGRectGetWidth(self.view.bounds), 78.0f);
//        button.titleLabel.font = [UIFont fontWithName:@"OpenSans" size:20];
//    }
//
