...
@interface VTSelectiveBordersLayer (Private)
-(void) commonInit;
-(void) reloadBorders;
// TODO
...
@implementation VTSelectiveBordersLayer
...
-(void) setSelectiveBorderFlag:(VTSelectiveBordersFlag)newSelectiveBorderFlag
{
